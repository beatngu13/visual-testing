...
$(document).ready(function() { 
	...
	$('#fpbtn').click(function() {
		...
		$.getJSON("https://www.tribunnews.com/auth/forgot_password_json?callback=?", $("#fpform").serialize(), function(data) {
	...
	$('#logform').submit(function() {
		...
		$.getJSON("https://www.tribunnews.com/auth/login_json?callback=?", $("#logform").serialize(), function(data) {
	...
	$('#rform').submit(function() {
		...
		$.getJSON("https://www.tribunnews.com/auth/register_json?callback=?", $("#rform").serialize(), function(data) {
